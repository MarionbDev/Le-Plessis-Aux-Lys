...
export default function ContactPage() {
  return (
    <>
      <div className=" min-h-screen font-text flex flex-col lg:flex-row gap-16 lg:gap-4 lg:mx-4 md:justify-around items-center mt-12 mb-32  xl:mb-0 pb-12">
        <div className="flex flex-col  lg:w-[33rem] xl:w-[40rem] md:gap-8 lg:gap-20 xl:gap-10">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-4 my-12 md:mt-0 lg:-mt-20 ">
