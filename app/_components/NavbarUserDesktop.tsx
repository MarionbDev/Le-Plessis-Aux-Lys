  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center gap-4 pt-6">
        <h1 className="font-title-home text-[#5e5e1e] italic font-extralight  ml-2 md:ml-10   text-3xl sm:text-2xl xl:text-[2.6rem] tracking-[3px]  ">
          Le Plessis Aux Lys
        </h1>
        <span className="flex justify-center -mt-2  lg:w-[5rem] xl:w-[8rem] md:ml-10  border-t-2  border-separator"></span>
      </div>
