...
//                         className=" object-contain  w-[20rem] lg:w-[32rem] rounded-sm     "
//                       />
//                       {/* <Image
//                         src={moulins}
//                         width={300}
...
//               >
//                 <p className=" text-[0.9rem] pb-10 my-8 md:my-12 lg:my-4 mx-6 sm:mx-10 md:mx-20 lg:mx-44">
...
//         >
//           <div className="flex justify-center flex-col items-center   text-md lg:text-md  mt-20  xl:mt-44  leading-loose">
//             <div className="w-4/5 flex flex-col lg:flex-row items-center justify-center   mt-16 lg:mt-0 gap-4 lg:gap-12 lg:my-20">
//               <span className="flex justify-center w-[16rem]  border-t-2  border-separator"></span>
...
//               <span className="flex  justify-center w-[16rem] border-t-2  border-separator"></span>
//             </div>
//             <div className="w-full flex justify-center  bg-[#f5f7dc]/50  rounded-t-[4rem]  my-10 md:my-12 lg:my-4 ">
//               <div className="mx-[2rem] md:mx-10 lg:mx-10 xl:mx-32  p-4  my-6 md:my-14 xl:max-w-[100rem]  leading-loose   ">
...
//                       transition={{ duration: 0.6 }}
//                     >
//                       <p className="text-[0.9rem] mb-10  sm:mx-10 md:mx-20 lg:mx-36  ">
...
//                   <div className="flex flex-col items-center justify-center md:flex-row md:flex-wrap  gap-6 md:gap-10 ">
//                     <motion.section
//                       initial="hide"
//                       whileInView="show"
//                       exit="hide"
...
//                           height={100}
//                           alt="Photo du parc du gîte"
//                           className=" object-contain w-[20rem]   rounded-sm   shadow-div    "
//                         />
//                       </motion.div>
//                     </motion.section>
//                     <motion.section
...
//                           height={200}
//                           alt="Photo du parc du gîte"
//                           className=" object-contain w-[14rem]  rounded-sm    shadow-div  "
//                         />{" "}
//                       </motion.div>
//                     </motion.section>
//                     <motion.section
...
//                           height={100}
//                           alt="Photo du parc du gîte"
//                           className=" object-contain w-[20rem] lg:object-scale-down  rounded-sm  shadow-div    "
//                         />
//                       </motion.div>
//                     </motion.section>
//                   </div>
...
//           transition={{ duration: 0.5 }}
//         >
//           <div className="flex justify-center flex-col items-center text-md lg:text-md  mt-12 md:mt-20 xl:mt-44 leading-loose ">
//             <div className="w-4/5 flex flex-col lg:flex-row items-center justify-center mt-16 lg:mt-0 gap-4 lg:gap-12 lg:my-20">
//               <span className="flex justify-center w-[16rem]  border-t-2  border-separator"></span>
//               <p className=" font-semibold text-center lg:text-lg uppercase ">
//                 à voir et à faire
...
//               <span className="flex justify-center w-[16rem] border-t-2  border-separator"></span>
//             </div>
//             <div className="bg-[#f5f7dc]/50 rounded-t-[4rem] mt-10  md:my-12 lg:my-4">
//               <div className="mx-[2rem] md:mx-10 lg:mx-10 xl:mx-32  p-4  my-6 md:my-14 xl:max-w-[100rem]  leading-loose   ">
//                 <motion.section
//                   initial="hide"
//                   whileInView="show"
...
//                     transition={{ duration: 0.5 }}
//                   >
//                     <p className=" text-[0.9rem]  mx-6 sm:mx-10 md:mx-20 lg:mx-44 xl:mx-72 ">
...
//                       merveilles locales, à la rencontre d'une Vendée
...
//           transition={{ duration: 0.5 }}
//         >
//           <div className="flex justify-center flex-col items-center text-md lg:text-md mt-20 mx-4  md:mt-24 md:scroll-mt-32 xl:mt-44  leading-loose">
//             <div className="w-4/5 flex flex-col lg:flex-row items-center justify-center mt-16 lg:mt-0 gap-4 lg:gap-12 lg:my-20">
//               <span className="flex justify-center w-[16rem]  border-t-2  border-separator"></span>
//               <p className=" font-semibold text-center lg:text-lg uppercase lg:w-[27rem]  ">
...
//                     gîtes ou chambres d'hôtes au cœur de la Vendée.
//                     Contactez-nous dès maintenant via notre{" "}
//                     <Link href={"/nous-contacter"} className=" text-[#bbbb57]">
//                       formulaire de contact
//                     </Link>{" "}
//                     et réserver votre séjour unique dans notre cadre
//                     exceptionnel. Nous serons ravis de vous accueillir pour une
//                     expérience insolite et inoubliable dans l'une de nos maisons
//                     d'hôtes.
//                   </p>
//                 </motion.div>
//               </motion.section>
