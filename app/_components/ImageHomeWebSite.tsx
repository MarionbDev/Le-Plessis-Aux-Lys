      ...
      >
        ...
        >
          <div className="home-title flex flex-col justify-center gap-4 md:mb-10  ">
            ...
            <span className=" w-[7rem] md:ml-10  border-t-2  border-separator"></span>
          </div>
          <div className="image-home">
            <h2 className="flex flex-col justify-center items-center mt-12  mb-10 md:mb-20 font-prata  text-[#a18527] uppercase mx-2  text-3xl  lg:text-3xl xl:text-4xl max-[390px]:tracking-[1px] max-[461px]:tracking-[2px] min-[462px]:tracking-[6px]  ">
              <p className="">Gîte</p>
              <p className=" ">&</p>
